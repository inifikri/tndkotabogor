...
class TCPDF {
	...
	{ 
	   ...
	   $logoX = 10; // 
	   $logoFileName = "http://localhost/tnd/assets/img/bsre.png";
	   $logoWidth = 21; // 15mm
	   $logoY = 316;
	   ...
	   $this->SetY(-12);
		...
		$ketCert = 'Dokumen ini telah ditandatangani secara elektronik menggunakan Sertifikat Elektronik yang diterbitkan oleh Balai Sertifikasi Elektronik (BSrE) Badan Siber dan Sandi Negara';	
		$this->MultiCell(160, 0, $ketCert, 0, 'L', 0, 0, 33, '', true, 0, false, true, 8, 'M');  
