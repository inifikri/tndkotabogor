...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Form Nota Dinas</h2>
</div>
<!-- END PAGE TITLE -->                
                    ...
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Sifat</label>
                                    <div class="col-md-9">                                                                                
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Lampiran Lainnya</label>
                                    <div class="col-md-9">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">                                        
                                    <label class="col-md-3 control-label">Daftar Lampiran</label>
                                    <div class="col-md-9">
                                        <textarea class="summernote" name="daftar_lampiran"> </textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel-body">                                                                        
                                        ...
                                        <div class="faq-item">
                                            ...
                                            <div class="faq-text">
                                                ...
                                                <?php foreach (listOpd($this->uri->segment(4)) as $key => $o) { ?>
                                                    <p>
                                                        - <?php echo $o->nama_pd ?> 
                                                        <a href="<?php echo site_url('suratkeluar/notadinas/delete_kepada/'.$this->uri->segment(4).'/'.$o->dsuratkeluar_id) ?>" class='btn btn-danger btn-rounded' data-toggle='tooltip' data-placement='right' title='Hapus OPD' onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class='fa fa-times'></i></a>
                                                    </p>
                                                <?php } ?>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">                                        
                                <label class="col-md-3 control-label">Daftar Lampiran</label>
                                <div class="col-md-9">
                                    <textarea class="summernote" name="daftar_lampiran"> <?php echo $e->daftar_lampiran ?> </textarea>
                                </div>
                            </div>
                        </div>
