...
<div class="page-title">                    
    <h2><span class="fa fa-envelope"></span> Surat Perintah Tugas </h2>
</div>
<!-- END PAGE TITLE -->                
                        ...
                        <tbody>
                            ...
                            <tr>
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <?php 
                                                $berada = $this->db->query("
                                                    ...
                                                    WHERE surat_perintahtugas.id = '$h->id'
                                                ")->row_array();
                                ...
                                <td align="center">
                                    ...
                                    ?>
                                    <a href="<?php echo site_url('export/perintahtugas/'.$h->id) ?>" title="Lihat Surat" target="_blank"><i class="fa fa-eye"></i></a>
                                    <?php
                                        }else{
                                    ?>
                                        ...
                                        <div class="modal fade" id="modalLihat<?php echo $h->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <a href="<?php echo site_url('export/perintahtugas/'.$h->id) ?>" title="Lihat Surat" target="_blank" style="text-decoration: none;">Lihat Surat</a> <br>
                                                <a href="<?php echo base_url('assets/lampiransurat/perintahtugas/'.$h->lampiran_lain) ?>" title="Lihat Lampiran" target="_blank" style="text-decoration: none;">Lihat Lampiran</a>
                                              </div>
                                              <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                              </div>
                                    ...
                                    ?>
                                    | <a href="<?php echo site_url('suratkeluar/perintahtugas/edit/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Edit Surat"><i class="fa fa-pencil"></i></a> 
                                    
                                    <?php if ($h->dibuat_id == $this->session->userdata('jabatan_id')) { ?>
                                    | <a href="<?php echo site_url('suratkeluar/perintahtugas/delete/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Hapus Surat" onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class="fa fa-trash-o"></i></a>
                                    <?php 
                                                }
                                            }
                                        }
