                    ...
                    <table class="table datatable table-responsive table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo site_url('export/memo/'.$h->id) ?>" title="Lihat Surat" target="_blank"><i class="fa fa-eye"></i></a> 
                                    ...
                                    ?>
                                    | <a href="<?php echo site_url('suratkeluar/memo/edit/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Edit Surat"><i class="fa fa-pencil"></i></a> 
                                    
                                    <?php if ($h->dibuat_id == $this->session->userdata('jabatan_id')) { ?>
                                    | <a href="<?php echo site_url('suratkeluar/memo/delete/'.$h->id) ?>" data-toggle="tooltip" data-placement="top" title="Hapus Surat" onclick="return confirm('Apakah anda yakin akan menghapus?')"><i class="fa fa-trash-o"></i></a>
                                    <?php 
                                                }
                                            }
                                        }
